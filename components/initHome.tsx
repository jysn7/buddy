...
//           Study smarter, <br />
//           <span className="text-transparent bg-clip-text bg-linear-to-b from-yellow-100 via-yellow-200 to-yellow-300">
//             not harder.
//           </span>
//         </h1>
...
//           <Link
//             href="/auth/signup"
//             className="group relative px-8 py-4 bg-white text-zinc-950 font-medium rounded-full transition-all hover:bg-zinc-200 shadow-[0_0_50px_-5px_rgba(255,255,255,0.6)] flex items-center justify-center gap-2 text-base"
//           >
//             Get started
...
//           <Link 
//             href="/methodology"
//             className="px-8 py-4 bg-zinc-900/30 hover:bg-zinc-900/40 text-white border border-zinc-800 font-medium rounded-full transition-all md:backdrop-blur-xs flex items-center justify-center">
//             How it works
//           </Link>
//         </div>
