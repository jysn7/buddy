...
export default function SigninPage() {
  ...
  return (
    <div
      id="login-view"
      className="fixed inset-0 z-50 bg-zinc-950 flex flex-col items-center justify-center animate-enter overflow-hidden"
    >
      {/* GLOW BACKGROUND */}
      ...
      <div className="relative z-10 w-full max-w-[340px] px-4">
        {/* LOGO */}
        <div className="mx-auto w-12 h-12 bg-zinc-900 rounded-2xl flex items-center justify-center mb-10 border border-zinc-800 shadow-2xl relative group">
          <div className="absolute inset-0 bg-yellow-400/20 blur-xl opacity-50 group-hover:opacity-100 transition-opacity"></div>
          <Aperture className="w-6 h-6 text-yellow-400 relative z-10 spin-slow" />
        </div>
        ...
        <form onSubmit={handleSignIn} className="space-y-3">
          <Input
            ...
            className="w-full input-dark rounded-lg px-3 py-2.5 text-sm text-white placeholder:text-zinc-600"
            value={email}
          ...
          <Button
            type="submit"
            disabled={loading}
            className="w-full bg-white hover:bg-yellow-400 text-black font-bold py-2.5 rounded-lg transition-colors text-sm mt-1"
          >
        ...
        <p className="text-center text-[10px] text-zinc-600 mt-10 leading-relaxed">
          ...
          <Link 
            href="/legal#terms"
            className="underline hover:text-zinc-400">Terms</Link> and{" "}
          <Link 
            href="/legal#policy"
